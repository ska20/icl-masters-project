...
def train(type, results_type):
    ...
    for item in train_list:
        ...
        for epsilon in eps_list:
            ...
            dataset = lifesci(real_data_path, fake_data_path, None) #Instantiate lifesci dataset object
...
if __name__ == "__main__":
    train('pategan', 'pategan')
    train('dpcopula', 'dpcopula')
    train('dpwgan', 'dpwgan')
    train('datasynthesizer', 'datasynthesizer')
